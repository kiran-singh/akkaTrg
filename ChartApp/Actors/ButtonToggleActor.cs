...
{
    private readonly Metric.CounterType _myCounterType;
    ...
    public ButtonToggleActor(IActorRef coordinatorActor, Button myButton, Metric.CounterType myCounterType, bool isToggledOn = false)
    {
